...
def main():
    ...
    st.markdown("Are your mushrooms edible or poisonous? đŸ „")
    st.sidebar.markdown("Are your mushrooms edible or poisonous? đŸ „")

    @st.cache_data(persist=True)
    def load_data():
        path= "/content/drive/My Drive/Computadora Virtual/Data Analytics/Actualizacion/5. Despliegue/Build a Machine Learning Web App with Streamlit and Python/streamlit-ml/"
        path= "./data/"
        file = path + "/mushrooms.csv"
